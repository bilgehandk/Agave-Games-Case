...
/// <summary>
/// Utility class for generating and rendering smooth curves
/// </summary>
public static class LineUtils
{
    ...
    /// <summary>
    /// Generates a smooth Bezier curve from a list of points
    /// </summary>
    /// <param name="points">List of points to create a curve through</param>
    /// <param name="segmentsPerCurve">Number of segments between each pair of points</param>
    /// <returns>A list of points forming a smooth curve</returns>
    ...
    /// <param name="t">Parameter value (0-1)</param>
    ...
    /// <summary>
    /// Applies a smooth curve to a LineRenderer
    /// </summary>
    /// <param name="lineRenderer">LineRenderer to update</param>
    /// <param name="points">Points to create a curve through</param>
    /// <param name="segmentsPerCurve">Number of segments between each pair of points</param>
